...
# from datasets.football_yolov3_train import get_loader
from datasets.mot_seq_for_YOLO import get_loader
...
dataloader = get_loader(root='data/MOT16/train', det_root=None, name='MOT16-02', min_height=0, num_workers=0)
