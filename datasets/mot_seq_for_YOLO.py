...
def get_loader(root, det_root, name, min_height=0,  num_workers=3):

    dataset = MOTSeq(root, det_root, name, min_height, min_det_score=-np.inf)
    data_loader = data.DataLoader(dataset, 1, False, num_workers=num_workers)
    return data_loader